      ...
      <div className="container">
        <div className="flex flex-wrap">
          <div className="w-full self-center px-4 lg:w-1/2">
            ...
            <a target='_blank' rel="noreferrer" href="/public/Cv-StepanusRioDefaArdiantoro.pdf" className='py-2 px-3 border border-slate-500 ml-3 rounded-md hover:border-primary hover:text-primary' download={true}>Download CV</a>
          </div>
